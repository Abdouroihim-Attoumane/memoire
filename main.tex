...
\end{titlepage}
    ...
    \include{chapitre/introductionG} % Importation de l'introduction générale

    \input{chapitre/chapitre1} % Importation du chapitre 1

    \input{chapitre/chapitre2} % Importation du chapitre 2

    \input{chapitre/chapitre3} % Importation du chapitre 3

    \input{chapitre/chapitre4} % Importation du chapitre 4

    \input{chapitre/chapitre5} % Importation du chapitre 5

    \input{chapitre/chapitre6} % Importation du chapitre 6

    \input{chapitre/chapitre7} % Importation du chapitre 7
     
    \input{chapitre/conclusionG} % Importation du chapitre 3
